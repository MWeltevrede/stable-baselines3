...
from stable_baselines3.common.buffers import DictReplayBuffer, ReplayBuffer, ExploreGoReplayBuffer
...
class ExploreGoOffPolicyAlgorithm(OffPolicyAlgorithm):
    """
    The base for Explore-Go Off-Policy algorithms (ex: SAC/TD3)
    ...
    def __init__(
        ...
        gradient_steps: int = 1,
        action_noise: Optional[ActionNoise] = None,
        replay_buffer_class: Optional[Type[ExploreGoReplayBuffer]] = ExploreGoReplayBuffer,
        replay_buffer_kwargs: Optional[Dict[str, Any]] = None,
        optimize_memory_usage: bool = False,
        policy_kwargs: Optional[Dict[str, Any]] = None,
        stats_window_size: int = 100,
    ...
    def collect_rollouts(
        ...
        callback: BaseCallback,
        train_freq: TrainFreq,
        replay_buffer: ExploreGoReplayBuffer,
        action_noise: Optional[ActionNoise] = None,
        learning_starts: int = 0,
        log_interval: Optional[int] = None,
    ) -> RolloutReturn:
